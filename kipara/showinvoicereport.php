...
<thead>
    ...
    echo '<td style="text-align:  center;"><strong>Dispatch Through</strong></td>';
    echo '<td style="text-align:  center;"><strong>Paymentmode</strong></td>';
    ...
    echo '<td style="text-align:  right;padding-right: 5px;"><strong>Final Total</strong></td>';
    echo '<td style="text-align:  right;padding-right: 5px;"><strong>GST 2%</strong></td>';
    echo '</tr>';
      ...
      $count++;
       ...
       if($count == 1)
	    {	
            ...
            echo "<td style='text-align: center;'>$dispatch</td>";
            echo "<td style='text-align: center;'>$paymentmode</td>";
            ...
            echo "<td style='text-align: right;padding-right: 5px;'>$gstamt</td>";
            echo '</tr>';
        }
	    if($count > 1)
	    {   
    ...
    <tr>
        ...
        <td style="text-align: right;padding-right: 5px;"><?php echo number_format($totamt);?></td>
        <td style="text-align: right;padding-right: 5px;"><?php echo number_format($total1);?></td>
		<td style="text-align: right;padding-right: 5px;"><?php echo number_format($totgst);?></td>
...
<p style="margin-left:430px;padding-top:-400px;">
