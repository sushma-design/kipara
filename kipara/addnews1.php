...
?>
                        ...
                        <tbody>
                            <?php
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <img src="<?php echo $row['img1'];?>" width="60px;" height="45px;" alt="image.jpg">
                                    </td>
                                    <td>
                                            ...
                                            <div class="row">
                                                <div class="col-sm-6">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="file" class="form-control" id="file1" accept="/newsphotos/*" name="file1" onchange="preview_image1(event)" multiple
                                                            data-show-upload="false" data-show-caption="true" placeholder="Attach Signature">
    ...
    <script>
        ...
        function insertnews() {
            ...
            // for (var i = 0; i < $('#pro-image').prop('files').length; i++) {
            $file_data = $('#pro-image').prop('files')[0];
            // $form_data.append('file' + (i + 1), $file_data);
            // }
        ...
        function updatenews(id) {
            ...
            $.ajax({
                ...
                success: function (data) {
                    ...
                    $("#id").val(id);
                    document.getElementById("img2").img.src = imagepath;
