...
//            var name2 = $("#itemname-"+j).val();
            ...
            if (itemSelect2 == 'notselected') {
                alert('Please Select Additional Information to Add!');
                return false;
            }
            else {

                document.form1.action = "saveinfohead.php";
        ...
        function add_cat() {
            ...
            $('#itemTable').html('');
            var result1 = '<tr><th style="font-size: 16px;">Sr.No.</th><th style="font-size: 16px;">Heading</th></tr>';
            ...
            for (var i = 1; i <= parseInt(itemSelect); i++) {
                ...
                result += '<td><input type="text" class="form-control" name="itemcat[]" style="width:250px;"  id="itemcat-'+i+'" placeholder="Heading"></td>';
                result += '<tr>';
                ...
                <div class="col-lg-12 col-xs-12">
                    <form role="form" method="post" name="form1" >
                        <div class="box box-danger"style="padding: 0px 0px 0px 20px;">
                            ...
                            <table id="itemTable" >
                                <label class="control-label" style="float: left; margin: 20px 20px 0px 0px;">Select Number of Additional Information to Add:</label>
