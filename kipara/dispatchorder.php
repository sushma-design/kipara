                        ...
                        <?php } ?>
                            <td align="center" id="td-<?php echo $orderno;?>" colspan="6">
                                ...
                                <table style="border: hidden; margin: 10px;" >
                                    <tr>
                                        <td align="right" style="border-right:hidden"><input type="button" id="dispatch" value="Recieved" style="height:50px; width:100px" onclick="acceptorder(<?php echo $orderno;?>)"/></td>
