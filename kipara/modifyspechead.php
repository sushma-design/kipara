...
<script>
    ...
    function validation()
    {
        ...
        document.form1.action = "updatespechead.php";
                    ...
                    <form role="form" method="post" name="form1" action="" >
                        <table  class="" style="margin : 10px 20px 0px 0px;width: 25%">
                            ...
                            <tr>
                                ...
                                <th style="font-size: 16px; text-align: center">Specification</th>
                            ...
                            <tr>
                                ...
                                <td> <div class="col-md-12">
                                        <input type="text" style="width: 250px;" class="form-control" value="<?php echo  $infohead; ?>" name="infohead[]"  id="infohead-<?php echo $count;?>">
                                    </div></td>
                            </tr>
