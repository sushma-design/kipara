...
<input type="hidden" id="page" value="partner">
<!-- Content  -->
<div id="pageTitle">
    <div class="container">
        <!-- Breadcrumbs Block -->
...
<div id="pageContent">
    <div class="block offset-sm">
        <div class="container">
            <div class="row">
                <div class="col-md-12">If you wants a Partnership with us , please fill out a Partnership request form below. Or if you prefer, you can reach us at the following address:</div>
            </div>
            <br/><br/>
            <div class="row">
                <div class="col-sm-5">
                    <h3 class="h-lg"><span class="color"><b>Become Our Partner</b></span> &nbsp;Request Form</h3>
					<form  id="comment_form1" style="margin-top:-15px;" action="" method="POST">
                        <div class="row">
                            ...
                            <div class="col-md-12">
                                ...
                                <div class="form-group">
                                    <div class="btn-submit btn-common-white" >
                                        <button type="button" class="btn" onclick="saveform1();"id="btn_order_submit" /><i class="icon icon-lightning"></i><span>Send Message</span></button>
                                    </div>      
                                </div>
                            </div>
                        </div>
                ...
                <div class="col-sm-5">
                    <img style="" alt="" src="images/partner01.jpg" >
                </div> 
            </div>
        </div>
    </div>
