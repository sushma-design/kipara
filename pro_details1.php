...
#quantity { 
    padding:5px; width:35px; height: 42px; border: 1px solid #555; 
}
 label {
...
// });
 function addtocart()
 {
    // alert "hiiii";
     ...
     var unit = $("#unit").val();
     var rs = $("#rs1").val();
     var unit1 = $("#unit11").val();
    //  alert(unit1);
     var productname = $("#productname").val();
     var productid = $("#productid").val();
    //  alert(productid);
     var totalrs = parseFloat(qty) * parseFloat(unit1);
     ...
     if(unit == '')
     {
         alert("Please Enter Unit");
           ...
           return false;
            ...
            document.getElementById("button1").innerHTML = '<i class="fa fa-shopping-cart"></i>&nbsp;&nbsp;ADDED TO CART';
            document.getElementById("button1").setAttribute("class","button2 button5");
    ...
    <div class="row services-alt tab-pane fade in active" id="services1">
        ...
        <div class="col-md-9">
			...
			<div class="col-md-7">
				...
				<h4><strong>Rs.&nbsp;<span id="unit1"><?php echo $mainprice;?></span><input type="hidden" id="unit11"> <del>Rs.&nbsp;<span id="unit2"><?php echo $scratchprice;?></span></del></strong></h4>
				<div class="col-sm-12"> 
					<div class="col-sm-4">
				...
				&ensp;&ensp;&ensp;&ensp;
                <a onclick="addtocart();"><button type="button" id="button1" class="button button5"><i class="fa fa-shopping-cart"></i>&nbsp;&nbsp;ADD TO CART</button></a>
            ...
            <div class="col-sm-12">
                ...
                <div class="services-block-alt col-md-4">
                    ...
                    <div class="caption">
                        <h4><a href="pro_details1.php?id=<?php echo $row7['id']?>"><?php echo $productname1;?></a></h4>
                        <h4><b>Rs.&nbsp;<?php echo $mainprice1;?> <del>Rs.&nbsp;<?php echo $scratchprice1;?></del></b></h4>			
                        <div class="text">
